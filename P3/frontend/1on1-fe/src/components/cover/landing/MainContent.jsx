...
function MainContent() {
    ...
    return (
        <main className="container py-5">
            <h2 className="text-center mb-4">Discover the easiest way to schedule and manage your 1:1 meetings</h2>
            ...
            <div className="text-center mt-5">
                <Link to="/signup" className="btn btn-lg btn-light fw-bold border-white btn-log-in">Get Started</Link>
            </div>
        </main>
    );
}
