function CalendarCard({ id, name, owner, participants, meetings }) {
  return (
    <div className="card m-2 bg-body-secondary" style={{ width: "18rem" }}> {/* bg-light for subtle background differentiation */}
