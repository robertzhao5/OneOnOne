        ...
        <header className="mb-auto">
            <div>
                ...
                <nav className="nav nav-masthead justify-content-center float-md-end">
                    ...
                    <NavLink className="nav-link fw-bold py-1 px-0" to="/suggest">Suggested</NavLink>
                    <NavLink className="nav-link fw-bold py-1 px-0" to="/event-details" aria-current="page">Event Details</NavLink>
